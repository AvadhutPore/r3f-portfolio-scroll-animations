export const Menu = (props) => {
    ...
    return(
        <>
            <button onClick={() => setMenuOpen(!menuOpen)} className="z-20 fixed top-12 right-12 p-3 bg-indigo-600 w-11 h-11 rounded-md">
            ...
            {/* Menu Panel */}
            <div className={`z-10 fixed top-0 right-0 bottom-0 bg-white transition-all overflow-hidden flex flex-col ${menuOpen ? "w-80" : "w-0"}`}>
